...
const PRODUCTS = [
  ...
  ["eat-that-frog", "Eat That Frog!", "Brian Tracy", "book"],
  ["deep-work", "Deep Work", "Cal Newport", "book"],
  ["get-smart", "Get Smart!", "Brian Tracy", "book"],
  ["success-is-not-an-accident", "Success Is Not an Accident", "Tommy Newberry", "book"],
  ["who-moved-my-cheese-for-teens", "Who Moved My Cheese? for Teens", "Spencer Johnson", "book"],
  ["the-richest-man-in-babylon", "The Richest Man in Babylon", "George S. Clason", "book"],
  ["think-and-grow-rich", "Think and Grow Rich", "Napoleon Hill", "book"],
  ["ikigai", "Ikigai", "García and Miralles", "book"],
  ["the-mountain-is-you", "The Mountain Is You", "Brianna Wiest", "book"],
  ["zero-to-one", "Zero to One", "Peter Thiel", "book"],
  ["the-power-of-self-discipline", "The Power of Self-Discipline", "Brian Tracy", "book"],
  ["7-strategies-for-wealth-and-happiness", "7 Strategies for Wealth & Happiness", "Jim Rohn", "book"],
  ["built-to-last", "Built to Last", "Jim Collins", "book"],
  ["making-it-big", "Making It Big", "Femi Otedola", "book"],
  ["steal-like-an-artist", "Steal Like an Artist", "Austin Kleon", "book"],
  ["never-split-the-difference", "Never Split the Difference", "Chris Voss", "book"],
  ["an-enemy-called-average", "An Enemy Called Average", "John L. Mason", "book"],
  ["7-habits-of-highly-effective-people", "The 7 Habits of Highly Effective People", "Stephen R. Covey", "book"],
  ["as-a-man-thinketh", "As a Man Thinketh", "James Allen", "book"],
  ["the-diary-of-a-ceo", "The Diary of a CEO", "Steven Bartlett", "book"],
];
